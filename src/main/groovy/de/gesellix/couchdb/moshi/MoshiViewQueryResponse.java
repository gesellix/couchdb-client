...
public class MoshiViewQueryResponse<DocType> implements ViewQueryResponse<DocType> {
  ...
  @Json(name = "rows")
  private List<MoshiViewQueryResponseRow<DocType>> rows = new ArrayList<>();
  ...
  @Override
  public List<MoshiViewQueryResponseRow<DocType>> getRows() {
    return rows;
  }


  public void setRows(List<MoshiViewQueryResponseRow<DocType>> rows) {
    this.rows = rows;
  }
